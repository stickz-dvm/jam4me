...
export function RequestSongCard({
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: 20 }}
            className="w-full space-y-6 p-6 md:p-10 rounded-[2rem] bg-[#001C3D]/40 text-white shadow-[0_0_40px_rgba(59,130,246,0.3)] border border-blue-400/30 relative overflow-hidden backdrop-blur-xl"
        >
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                    ...
                    >
                        <div className="aspect-square w-full rounded-3xl overflow-hidden shadow-2xl border border-white/10 group">
                            {track.album?.images?.[0]?.url ? (
                                <img
                                    src={track.album.images[0].url}
                                    alt={track.name}
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Mobile preview - hidden on desktop since we have the large preview */}
                        <div className="md:hidden relative overflow-hidden rounded-2xl bg-white/[0.03] backdrop-blur-xl p-4 flex items-center gap-4 border border-white/10 shadow-xl">
